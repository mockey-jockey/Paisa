...
class SendSMSContainer extends Component {
    ...
    getAcctAndCardNumber = (message) => {
        ...
        cardRegex = /(?:\scard\s*)([0-9|*|X]{6})/gmi,obj={bankName:message.address};
    ...
    getMerchantName = (message) => {
        ...
        var cardNumber = JSON.stringify(this.getAcctAndCardNumber(message));
    ...
    parseMessage = (object,type) => {
        ...
        console.log('-->' + type);
        console.log('-->' + JSON.stringify(this.getAcctAndCardNumber(object.data)));
