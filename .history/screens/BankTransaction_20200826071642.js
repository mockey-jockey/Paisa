...
const BankTransaction = (props) => {
  ...
  const RenderBankTransactions = ({type}) => {
    ...
    return <View style={{flex:1,display:'flex',flexDirection:'column',backgroundColor:'#fff',justifyContent:'center',alignContent:'center'}}><Text>No Transactions</Text></View>;
  }
