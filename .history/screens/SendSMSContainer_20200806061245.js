        ...
        SmsAndroid.list(
            ...
            (count, smsList) => {
                ...
                arr.forEach((object) => {
                    ...
                    if(object.body.indexOf('withdrawn') !== -1 || object.body.indexOf('debited') !== -1 || object.body.indexOf('spent') !== -1 || object.body.indexOf('deposited') !== -1 || object.body.indexOf('credited') !== -1){
                        console.log('------------------------------------------->');
