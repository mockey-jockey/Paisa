...
const BankTransaction = (props) => {
  ...
  const RenderBankTransactions = ({type}) => {
    ...
    if(banks.length){
      return (<View style={{flex:1,paddingLeft:0,paddingRight:0,marginLeft:0,marginRight:0,display:'flex'}}>{banks.map((item,index) => {
        ...
        return (<Card key={index} style={{paddingLeft:0,paddingRight:0,marginLeft:0,marginRight:0,display:'flex'}} >
