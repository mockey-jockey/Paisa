...
const BankTransaction = (props) => {
  ...
  const RenderBankTransactions = ({type}) => {
    ...
    return <View style={{flex:1,display:'flex',flexDirection:'column',backgroundColor:'#fff',justifyContent:'center',alignItems:'center'}}><Text style={{fontSize:20}}>No Transactions</Text></View>;
  }
