...
class SendSMSContainer extends Component {
    ...
    getAcctAndCardNumber = (message,address) => {
    ...
    getMerchantName = (message,address) => {
        ...
        var cardNumber = JSON.stringify(this.getAcctAndCardNumber(message,address));

        console.log(merchantName,cardNumber)
        return ((merchantName && merchantName.length && merchantName[1]) || (cardNumber && cardNumber.accountNumber) || '');
    }
    ...
    parseMessage = (object,type) => {
        ...
        console.log('-->' + this.getMerchantName(object.body,object.address));
        console.log('-->' + this.convertTimestampToDate(object.date));
        console.log('-->' + this.getAmount(object.body));
        console.log('-->' + type);
        console.log('-->' + JSON.stringify(this.getAcctAndCardNumber(object.body,object.address)));
