  ...
  const renderItem = ({ item }) => (
    <View style={card().cardViewStyle}>
      ...
      <View style={card().rightElements}>
        <Text style={{textAlign:'right'}}>{item.amount} {item.type === "credited" && <Icon name="sort-down" backgroundColor="#3b5998" />}{item.type === "debited" && <Icon name="sort-up" backgroundColor="#3b5998" />}</Text>
