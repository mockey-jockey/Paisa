                    ...
                    arr.forEach((object,index) => {
                        ...
                        if(bankNameIndex !== -1){
                            ...
                            if(object.body.indexOf('withdrawn') !== -1){
                                bankList[name].push(parseMessage(object,'withdrawn',index.toString()));
                            }else if(object.body.indexOf('debited') !== -1){
                                bankList[name].push(parseMessage(object,'debited',index.toString()));
                            }else if(object.body.indexOf('spent') !== -1){
                                bankList[name].push(parseMessage(object,'debited',index.toString()));
                            }else if(object.body.indexOf('deposited') !== -1){
                                bankList[name].push(parseMessage(object,'credited',index.toString()));
