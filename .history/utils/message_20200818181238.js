                ...
                (count, smsList) => {
                    ...
                    arr.forEach((object,index) => {
                        ...
                        if(object.body.indexOf('withdrawn') !== -1){
                            bankList.push(parseMessage(object,'withdrawn',index.toString()));
                        }else if(object.body.indexOf('debited') !== -1){
                            bankList.push(parseMessage(object,'debited',index.toString()));
                        }else if(object.body.indexOf('spent') !== -1){
                            bankList.push(parseMessage(object,'debited',index.toString()));
                        }else if(object.body.indexOf('deposited') !== -1){
                            bankList.push(parseMessage(object,'credited',index.toString()));
