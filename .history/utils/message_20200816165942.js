...
const parseMessage = (object,type) => {
    console.log('------------------------------------------->');
            ...
            (count, smsList) => {
                ...
                arr.forEach((object) => {
                    ...
                    if(object.body.indexOf('withdrawn') !== -1){
                        bankList.push(parseMessage(object,'withdrawn'));
                    }else if(object.body.indexOf('debited') !== -1){
                        bankList.push(parseMessage(object,'debited'));
                    }else if(object.body.indexOf('spent') !== -1){
                        bankList.push(parseMessage(object,'debited'));
                    }else if(object.body.indexOf('deposited') !== -1){
                        bankList.push(parseMessage(object,'credited'));
